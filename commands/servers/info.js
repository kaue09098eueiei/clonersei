    ...
    run: async (client, message, args) => {
        axios({
            ...
            axios({
                ...
                .addField('ðŸŸ¢ Status', resources.data.attributes.current_state, true)
                .addField('ðŸ’» CPU Usage', resources.data.attributes.resources.cpu_absolute + '%', true)
                .addField('ðŸ’» RAM Usage', pretty(resources.data.attributes.resources.memory_bytes), true)
                .addField('ðŸ’¾ DISK Usage', pretty(resources.data.attributes.resources.disk_bytes), true)
                .addField('ðŸ“¶ NET Usage', 'UPLOADED: ' + pretty(resources.data.attributes.resources.network_tx_bytes) + ', DOWNLOADED: ' + pretty(resources.data.attributes.resources.network_rx_bytes))
                .addField('ðŸ’» NODE', response.data.attributes.node)
